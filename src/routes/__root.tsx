...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Ahsan Mohammed" },
      ...
      { name: "twitter:title", content: "Ahsan Mohammed Backend Developer & Designer" },
      { name: "twitter:description", content: "Ahsan Mohammed Backend Developer & Designer" },
