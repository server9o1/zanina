...
const works = [
  {
    ...
    badge: "50+",
    blurb: "Anime Music Videos showcasing advanced editing techniques and creative storytelling",
  },
  {
    icon: ImageIcon,
    ...
    badge: "Multiple",
    blurb: "Professional photo manipulation and enhancement for diverse client requirements",
  },
  {
    icon: FileText,
    ...
    badge: "1 Publication",
    blurb: "Comprehensive educational resource on Blood Circulation created in Microsoft Word",
  },
  {
    icon: Table,
  ...
  },
  {
    ...
    badge: "Various",
    blurb: "Creative digital artwork and graphic design projects showcasing artistic skills",
  },
];
